...
function spherical_cavity_benchmark(ndofs, degree)
    ...
    partition = CartesianProduct((d,n) -> IncreasingRange(d,n), domain(mapping), (ndofs,ndofs,ndofs));
...
for p in 2
    for n in N
        ...
        e_displacement, e_stress = spherical_cavity_benchmark(n, p)
